    ...
    <div class="row align-items-center">
      ...
      <div class="col-12 col-lg-5 mx-lg-auto box">
        <div class="text-center text-lg-right">
          <h3 class="text-center pb-3 pt-2">Register and order food</h3>
          ...
          <?php echo form_open('user/register'); ?>
            <div class="form-group pill-input-lg">
              <input type="text" id="full_name" name="full_name" class="form-control rounded-pill" placeholder="Your name" required>
            </div>
            <div class="form-group pill-input-lg">
              <input type="email" id="email" name="email" class="form-control rounded-pill" placeholder="Email address" required>
            </div>
            <div class="form-group">
              <select id="food_choice" name="food_choice" class="custom-select custom-select-lg rounded-pill" required>
                <option disabled="" selected="" value="">Select your Food Choice</option>
